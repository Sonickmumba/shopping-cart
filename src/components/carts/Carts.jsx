...
const Carts = ({ cartData }) => {
  ...
  const totalCost = cartData ? cartData.reduce((cost, item) => cost + item.price, 0) : 0;
                    ...
                    <div key={item.id} className="flex justify-between items-center mt-6 pt-6 border-t">
                      ...
                      <div className="flex justify-center items-center">
                        <div className="pr-8 flex ">
                          ...
                          <input type="text" onChange={(e) => handleChange(e, item.id)} className="focus:outline-none bg-gray-100 border h-6 w-8 rounded text-sm px-2 mx-2" value="1" />
                          <span className="font-semibold">+</span>
                        </div>
                        <div className="pr-8 ">                          
